<div class="content-wrapper container">
    ...
    <div class="page-heading d-flex justify-content-between">
        <h4><?= $title; ?></h4>
        <a href="<?= base_url('addBn'); ?>" class="btn btn-primary">Tambah Data</a>
    </div>
                            ...
                            foreach ($data as $d) : ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-warning detail" data-id="<?= $d['id_baliknama']; ?>" data-bs-toggle="modal" data-bs-target="#exampleModal">Detail</button>
                                        <a href="<?= base_url('edPl/' . $d['id_baliknama']); ?>" class="btn btn-success">Edit</a>
                                        <button class="btn btn-danger delete" data-id="<?= $d['id_baliknama']; ?>">Hapus</button>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
