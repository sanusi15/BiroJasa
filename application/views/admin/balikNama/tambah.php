            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" action="<?= base_url('svBn'); ?>" method="POST">
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="nama">Nama</label>
                                            <input type="text" id="nama" class="form-control <?= form_error('nama') ? 'is-invalid' : ''; ?>" autofocus name="nama">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="alamat" class="form-control <?= form_error('alamat') ? 'is-invalid' : ''; ?>" autofocus name="alamat">
                                    ...
                                    <div class="col-12 d-flex justify-content-end">
                                        ...
                                        <a href="<?= base_url('bn'); ?>" class="btn btn-light-secondary me-1 mb-1">Back</a>
                                    </div>
                                </div>
                            </form>
                        </div>
