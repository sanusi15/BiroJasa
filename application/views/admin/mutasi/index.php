<div class="content-wrapper container">
    ...
    <div class="page-heading d-flex justify-content-between">
        <h4><?= $title; ?></h4>
        <a href="<?= base_url('addMt'); ?>" class="btn btn-primary">Tambah Data</a>
    </div>
                                ...
                                foreach ($data as $d) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button class="btn btn-warning detail" data-id="<?= $d['id_mutasi']; ?>" data-bs-toggle="modal" data-bs-target="#exampleModal">Detail</button>
                                            <a href="<?= base_url('edPl/' . $d['id_mutasi']); ?>" class="btn btn-success">Edit</a>
                                            <button class="btn btn-danger delete" data-id="<?= $d['id_mutasi']; ?>">Hapus</button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="alamat_baru" class="form-control" disabled>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group">
