            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" action="<?= base_url('svMt'); ?>" method="POST">
                                <div class="row">                                    
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="alamat_baru" class="form-control <?= form_error('alamat_baru') ? 'is-invalid' : ''; ?>" name="alamat_baru">
                                            <?php if (form_error('alamat_baru')) : ?>
                                                <div id="validationServer03Feedback" class="invalid-feedback">
                                                    <?= form_error('alamat_baru') ?>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
