            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" action="<?= base_url('svSg'); ?>" method="POST">
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="a/n_stnk">A/N STNK</label>
                                            <input type="text" id="a/n_stnk" class="form-control <?= form_error('a/n_stnk') ? 'is-invalid' : ''; ?>" autofocus name="a/n_stnk">
                                            <?php if (form_error('a/n_stnk')) : ?>
